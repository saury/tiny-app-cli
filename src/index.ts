...
program.name(name).version(version).description(description)
  .addOption(new Option('-p, --platform <platform>', '操作的平台').default(PLATFORM.WEIXIN).choices(Object.values(PLATFORM)))
  .addOption(new Option('-a, --action <action>', '提审或者发布').default(ACTION.REVIEW).choices(Object.values(ACTION)))
